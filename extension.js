...
exports.activate = (context) => {
	...
	sub.push(vscode.commands.registerCommand('Miva.beautify', formatActiveDocument.bind(0, true)));
	sub.push(vscode.commands.registerCommand('Miva.beautifyFile', formatActiveDocument));
